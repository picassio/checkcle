...
export const settingsTranslations: SettingsTranslations = {
  ...
  // Branding Settings
  brandingSettingsDesc: "Customize your application's appearance, logos, and social links",
  brandingSettingsSaved: "Branding settings saved successfully",
  brandingPermissionNotice: "As an admin user, you do not have access to branding settings. These settings can only be accessed and modified by Super Admins.",
  appearance: "Appearance",
  socialLinks: "Social Links",
  emailBranding: "Email Branding",
  appNameDesc: "The name displayed in the sidebar, browser title, and throughout the application",
  sidebarLogoUrl: "Sidebar Logo URL",
  sidebarLogoUrlDesc: "URL for the logo displayed in the sidebar (recommended: 24x24px)",
  loginLogoUrl: "Login Page Logo URL",
  loginLogoUrlDesc: "URL for the logo displayed on the login page (recommended: 64px height)",
  faviconUrl: "Favicon URL",
  faviconUrlDesc: "URL for the browser tab icon (recommended: .ico or .png format)",
  appDescription: "Application Description",
  appDescriptionDesc: "A short description of your application (used in meta tags)",
  preview: "Preview",
  sidebarLogo: "Sidebar Logo",
  loginLogo: "Login Logo",
  showSocialLinks: "Enable Social Links",
  showSocialLinksDesc: "Show social media links in the header and login page",
  githubUrl: "GitHub URL",
  twitterUrl: "Twitter/X URL",
  discordUrl: "Discord URL",
  docsUrl: "Documentation URL",
  linkVisibility: "Link Visibility",
  showLoginSocialLinks: "Show on Login Page",
  showLoginSocialLinksDesc: "Display social links on the login page",
  showHeaderSocialLinks: "Show in Header",
  showHeaderSocialLinksDesc: "Display social links in the application header",
  emailSenderNameBrandingDesc: "The sender name used in notification emails",
  emailFooterText: "Email Footer Text",
  emailFooterTextDesc: "Text displayed at the bottom of notification emails",
