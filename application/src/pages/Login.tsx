...
const Login = () => {
  ...
  return (
    <div className="flex flex-col items-center justify-center min-h-screen bg-background p-4">
      ...
      {branding.showSocialLinks && branding.showLoginSocialLinks && (
        <div className="mt-8 flex items-center justify-center space-x-6">
          {branding.showGithubLink && branding.githubUrl && (
            <button
              onClick={() => openExternalLink(branding.githubUrl)}
          ...
          {branding.showTwitterLink && branding.twitterUrl && (
            <button
              onClick={() => openExternalLink(branding.twitterUrl)}
              className="text-muted-foreground hover:text-foreground transition-colors"
          ...
          {branding.showDiscordLink && branding.discordUrl && (
            <button
              onClick={() => openExternalLink(branding.discordUrl)}
              className="text-muted-foreground hover:text-foreground transition-colors"
              aria-label="Discord"
            >
              <svg className="h-5 w-5" viewBox="0 0 24 24" fill="currentColor">
